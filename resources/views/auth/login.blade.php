                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{ asset('backend/assets/images/logo-light.png') }}" height="80" class="logo-dark mx-auto" alt="">
                                    <!--<img src="{{ asset('backend/assets/images/logo-light.png') }}" height="30" class="logo-light mx-auto" alt="">-->
                                </a>
                            </div>
                        </div>
    
                        <h4 class="text-muted text-center font-size-18"><b>Ingreso a WMS</b></h4>
 ...
 <form class="form-horizontal mt-3" method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group mb-0 row mt-2">
            <div class="col-sm-7 mt-3">
                <a href="{{ route('password.request') }}" class="text-muted"><i class="mdi mdi-lock"></i> Olvidó su contraseña?</a>
            </div>
