...
<html lang="en">
    ...
    <div class="alert alert-info alert-dismissible fade show" role="alert">
     Olvidó su contraseña?<strong> No hay problema.</strong> Simplemente háganos saber su dirección de correo electrónico y le enviaremos un enlace de restablecimiento de contraseña que le permitirá elegir una nueva.
    ...
    <div class="form-group mb-3">
        <div class="col-xs-12">
            <input class="form-control"  id="email" type="email" name="email"  required="" placeholder="Correo Electrónico">
             ...
             <div class="col-12">
             <button class="btn btn-info w-100 waves-effect waves-light" type="submit">Enviar Correo de Recuperación</button>
                                    </div>
                                </div>
                            </form>
                        </div>
