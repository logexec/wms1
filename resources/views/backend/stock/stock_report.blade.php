...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('stock.report.pdf') }}" target="_blank" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fa fa-print"> Imprimir Reporte </i></a> <br>  <br>               

                    <h4 class="card-title">Reporte de Stock </h4>
