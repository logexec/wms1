...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Editar Vehículo</h4><br><br>
        
            <form method="post" action="{{ route('vehiculo.update') }}" id="myForm">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="account_id" class="form-group form-select" aria-label="Default select example">
                            ...
                            <option value="{{ $cta->id }}"  @if ($vehiculo->account_id == $cta->id) {{ 'selected' }} @endif>{{ $cta->name }}</option>
                           @endforeach
                            </select>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="name" class="form-control" type="text" value="{{ $vehiculo->name }}">
                </div>
            </div>
            <!-- end row -->            
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="weight" class="form-control" type="number"  value="{{ $vehiculo->weight }}">
                </div>
            </div>
            <!-- end row -->     
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="volume" class="form-control" type="number"  value="{{ $vehiculo->volume }}">
                </div>
            </div>
            <!-- end row -->               
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="pallets" class="form-control" type="number"  value="{{ $vehiculo->pallets }}">
                </div>
            </div>
            <!-- end row -->     
            ...
            <!-- end row --> 
                ...
                <input type="submit" class="btn btn-info waves-effect waves-light" value="Actualizar Vehículo">
            </form>
