...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Crear Ubicación</h4><br><br>
        
            <form method="post" action="{{ route('ubicacion.store') }}" id="myForm">
                @csrf
        ...
        <!-- end row -->                
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="ranking" class="form-control" type="number">
                </div>
            </div>
            <!-- end row -->  
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="total_pallets" class="form-control" type="number">
                </div>
            </div>
            <!-- end row -->     
            ...
            <!-- end row -->            
                ...
                <input type="submit" class="btn btn-info waves-effect waves-light" value="Agregar Ubicación">
            </form>
