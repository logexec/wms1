                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Reporte de Stock</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo-light.png') }}" alt="logo" height="24"/>
                </h3>
            </div>
            <hr>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>Cuenta </strong></td>
            <td class="text-center"><strong>Unidad  </strong>
            </td>
            <td class="text-center"><strong>Familia</strong>
            </td>
            <td class="text-center"><strong>Producto</strong>
            </td>
            <td class="text-center"><strong>Ingresos  </strong>
            </td>
            <td class="text-center"><strong>Egresos  </strong>
            </td>
...
@endphp
        ...
        @endphp         
        <i>Hora de Impresión : {{ $date->format('j F , Y, g:i a') }}</i>   

                    <div class="d-print-none">
                        <div class="float-end">
                            <a href="javascript:window.print()" class="btn btn-success waves-effect waves-light"><i class="fa fa-print"></i></a>
                            <a href="#" class="btn btn-primary waves-effect waves-light ms-2">Descargar</a>
                        </div>
                    </div>
                </div>
            </div>
