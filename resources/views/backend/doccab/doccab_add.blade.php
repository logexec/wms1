...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Crear Documento </h4><br><br>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <select name="solicitante_id" id="solicitante_id" class="form-group form-select" aria-label="Default select example">
                       ...
                       <!-- <option value="{{ $sol->id }}">{{ $sol->company_name }} ({{ $sol->name }})</option>-->
                       @endforeach
                        </select>
                </div>
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <select name="destinatario_id" id="destinatario_id" class="form-group form-select" aria-label="Default select example">
                    ...
                    <!--<option value="{{ $des->id }}">{{ $des->company_name }} ({{ $des->name }})</option>-->
                   @endforeach
                    </select>
            </div>
        </div>
...
<!-- end row -->    
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="doc_creator_user" class="form-control" type="text">
                </div>
            </div>
            <!-- end row -->         
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="record_date" class="form-control" type="date">
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="start_doc_date" class="form-control" type="date">
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="start_doc_date_hour" class="form-control" type="datetime-local">
                </div>
            </div>
            <!-- end row -->   
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="finish_doc_date" class="form-control" type="date">
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="finish_doc_date_hour" class="form-control" type="datetime-local">
                </div>
            </div>
            <!-- end row -->       
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="total_qty" class="form-control" type="number">
                </div>
            </div>
            <!-- end row -->  
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="total_weight" class="form-control" type="number">
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="total_volume" class="form-control" type="number">
                </div>
            </div>
            <!-- end row --> 
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="doc_creator_user" class="form-control" type="date">
                </div>
            </div>
            <!-- end row -->  
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="point_sale" class="form-control" type="text">
                </div>
            </div>
            <!-- end row -->   
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="sales_channel" class="form-control" type="text">
                </div>
            </div>
            <!-- end row -->              
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="purchase_number" class="form-control" type="text">
                </div>
            </div>
            <!-- end row -->        
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="order_creator_user" class="form-control" type="text">
                </div>
            </div>
            <!-- end row -->            
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="invoice_auth_number" class="form-control" type="text">
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="invoice_print_date" class="form-control" type="text">
                </div>
            </div>
            <!-- end row -->        
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="erp_invoice_number" class="form-control" type="text">
                </div>
            </div>
            <!-- end row -->              
