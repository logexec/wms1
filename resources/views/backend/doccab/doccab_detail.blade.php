...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Visualizar Documento </h4><br><br>
            ...
            <form method="post" action="{{ route('doccab.store') }}" id="myForm">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select  name="account_id" id="account_id" class="form-group form-select" aria-label="Default select example" disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <select name="solicitante_id" id="solicitante_id" class="form-group form-select" aria-label="Default select example" disabled>
                        <option selected="" value="">Abrir este menú de selección</option>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <select name="destinatario_id" id="destinatario_id" class="form-group form-select" aria-label="Default select example" disabled>
                    <option selected="" value="">Abrir este menú de selección</option>
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-10">
            <select name="warehouse_id" id="warehouse_id" class="form-group form-select" aria-label="Default select example" disabled>
                <option selected="" value="">Abrir este menú de selección</option>
...
<!-- end row -->    
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="name" class="form-control" type="text" value="{{ $doccab->name }}" disabled>
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <select name="type" class="form-control" name="plan" disabled>
                        <option value="Ingreso" @if ($doccab->type == "Ingreso") {{ 'selected' }} @endif >INGRESO</option>
                        <option value="Egreso" @if ($doccab->type == "Egreso") {{ 'selected' }} @endif >EGRESO</option>
                        <option value="Inventario" @if ($doccab->type == "Inventario") {{ 'selected' }} @endif >INVENTARIO</option>                        
                    </select>
                </div>
            </div>
            <!-- end row -->  
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <select name="status" class="form-control" name="plan" disabled>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="doc_creator_user" class="form-control" type="text"  value="{{ $doccab->doc_creator_user }}" disabled>
                </div>
            </div>
            <!-- end row -->         
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="record_date" class="form-control" type="date"  value="{{ $doccab->record_date }}" disabled>
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="start_doc_date" class="form-control" type="date"  value="{{ $doccab->start_doc_date }}" disabled>
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="start_doc_date_hour" class="form-control" type="datetime-local"  value="{{ $doccab->start_doc_date_hour }}" disabled>
                </div>
            </div>
            <!-- end row -->   
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="finish_doc_date" class="form-control" type="date"   value="{{ $doccab->finish_doc_date }}" disabled>
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="finish_doc_date_hour" class="form-control" type="datetime-local" value="{{ $doccab->finish_doc_date_hour }}" disabled>
                </div>
            </div>
            <!-- end row -->       
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="total_qty" class="form-control" type="number" value="{{ $doccab->total_qty }}" disabled>
                </div>
            </div>
            <!-- end row -->  
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="total_weight" class="form-control" type="number" value="{{ $doccab->total_weight }}" disabled>
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="total_volume" class="form-control" type="number" value="{{ $doccab->total_volume }}" disabled>
                </div>
            </div>
            <!-- end row --> 
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <textarea name="comments" class="form-control" type="text" disabled>{{ $doccab->comments }}</textarea > 
                </div>
            </div>
            <!-- end row -->                 
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="order_number" class="form-control" type="text" value="{{ $doccab->order_number }}" disabled>
                </div>
            </div>
            <!-- end row -->             
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="doc_creator_user" class="form-control" type="date" value="{{ $doccab->doc_creator_user }}" disabled>
                </div>
            </div>
            <!-- end row -->  
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="point_sale" class="form-control" type="text" value="{{ $doccab->point_sale }}" disabled>
                </div>
            </div>
            <!-- end row -->   
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="sales_channel" class="form-control" type="text" value="{{ $doccab->sales_channel }}" disabled>
                </div>
            </div>
            <!-- end row -->              
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="purchase_number" class="form-control" type="text" value="{{ $doccab->purchase_number }}" disabled>
                </div>
            </div>
            <!-- end row -->        
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="order_creator_user" class="form-control" type="text" value="{{ $doccab->order_creator_user }}" disabled>
                </div>
            </div>
            <!-- end row -->            
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="invoice_number" class="form-control" type="text" value="{{ $doccab->invoice_number }}" disabled>
                </div>
            </div>
            <!-- end row -->    
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="invoice_auth_number" class="form-control" type="text" value="{{ $doccab->invoice_auth_number }}" disabled>
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="invoice_print_date" class="form-control" type="text" value="{{ $doccab->invoice_print_date }}" disabled>
                </div>
            </div>
            <!-- end row -->        
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="erp_invoice_number" class="form-control" type="text" value="{{ $doccab->erp_invoice_number }}" disabled>
                </div>
            </div>
            <!-- end row -->                      
            </form>            
