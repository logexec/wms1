...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Editar Cuenta </h4><br><br>
            

    


            <form method="post" action="{{ route('cuenta.update') }}" id="myForm">
                @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="name" class="form-control" type="text" value="{{$cuenta->name}}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="email" class="form-control" type="email" value="{{$cuenta->email}}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="phone" class="form-control" type="phone" value="{{$cuenta->phone}}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="responsible" class="form-control" type="text" value="{{$cuenta->responsible}}">
                </div>
            </div>
            <!-- end row -->
            ...
            <!-- end row -->
                ...
                <input type="submit" class="btn btn-info waves-effect waves-light" value="Actualizar Cuenta">
            </form>
