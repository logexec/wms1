...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Modificar Solicitante</h4><br><br>
        
            <form method="post" action="{{ route('solicitante.update') }}" id="myForm">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="account_id" class="form-group form-select" aria-label="Default select example">
                            ...
                            <option value="{{ $cta->id }}"  @if ($solicitante->account_id == $cta->id) {{ 'selected' }} @endif>{{ $cta->name }}</option>
                           @endforeach
                            </select>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="name" class="form-control" type="text" value="{{ $solicitante->name }}">
                </div>
            </div>
            <!-- end row -->            
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="company_name" class="form-control" type="text" value="{{ $solicitante->company_name }}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="fiscal_identification" class="form-control" type="text"  value="{{ $solicitante->fiscal_identification }}">
                </div>
            </div>
            <!-- end row -->   
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <select class="form-control" name="city">
                        <option value="">..</option>
                        <option value="QUITO"  @if ($solicitante->city == "QUITO") {{ 'selected' }} @endif>QUITO</option>
                        <option value="GUAYAQUIL" @if ($solicitante->city == "GUAYAQUIL") {{ 'selected' }} @endif>GUAYAQUIL</option>                                           
                    </select>
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <select class="form-control" name="state">
                        <option value="">..</option>
                        <option value="PICHINCHA"  @if ($solicitante->state == "PICHINCHA") {{ 'selected' }} @endif>PICHINCHA</option>
                        <option value="GUAYAS"  @if ($solicitante->state == "GUAYAS") {{ 'selected' }} @endif>GUAYAS</option>                                           
                    </select>
                </div>
            </div>
            <!-- end row -->                
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <select class="form-control" name="country">                        
                        <option value="ECUADOR"  @if ($solicitante->country == "ECUADOR") {{ 'selected' }} @endif>ECUADOR</option>                                                                
                    </select>
                </div>
            </div>
            <!-- end row -->  
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="zip" class="form-control" type="text"  value="{{ $solicitante->zip }}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="address" class="form-control" type="text" maxlength="255"  value="{{ $solicitante->address }}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="lat" class="form-control" type="number" value="{{ $solicitante->lat }}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="lon" class="form-control" type="number" value="{{ $solicitante->lon }}">
                </div>
            </div>
            <!-- end row -->     
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="phone" class="form-control" type="number" value="{{ $solicitante->phone }}">
                </div>
            </div>
            <!-- end row -->             
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="email" class="form-control" type="email" value="{{ $solicitante->email }}">
                </div>
            </div>
            <!-- end row -->                  
            
             
            <input type="submit" class="btn btn-info waves-effect waves-light" value="Actualizar Solicitante">
        </form>
