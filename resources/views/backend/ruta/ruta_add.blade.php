...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Crear Ruta </h4><br><br>
            ...
            <form method="post" action="{{ route('ruta.store') }}" id="myForm">
                ...
                <div class="row mb-3">
                    ...
                    <div class="form-group col-sm-10">
                        <input name="name" class="form-control" type="text" value="AUTOMÁTICO" disabled>
                    </div>
                </div>
                <!-- end row -->
                <div class="row mb-3">
        ...
        <!-- end row -->               
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="upload_date_hour" class="form-control" type="datetime-local">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="order_upload" class="form-control" type="number">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="start_route" class="form-control" type="date">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="finish_route" class="form-control" type="date">
                </div>
            </div>
            ...
            <!-- end row --> 
                <input type="submit" class="btn btn-info waves-effect waves-light" value="Agregar Ruta">
            </form>
