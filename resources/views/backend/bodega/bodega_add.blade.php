...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Crear Bodega de WMS </h4><br><br>
        
            <form method="post" action="{{ route('bodega.store') }}" id="myForm">
                @csrf
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="m2" class="form-control" type="number">
                </div>
            </div>
            <!-- end row -->     
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="m3" class="form-control" type="number">
                </div>
            </div>
            <!-- end row -->     
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="pallet_capacity" class="form-control" type="number">
                </div>
            </div>
            <!-- end row -->     
            ...
            <!-- end row -->            
                ...
                <input type="submit" class="btn btn-info waves-effect waves-light" value="Agregar Bodega">
            </form>
