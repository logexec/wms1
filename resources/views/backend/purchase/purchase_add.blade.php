...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Agregar Ingreso  </h4><br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="md-3">
                <label for="example-text-input" class="form-label">No Ingreso</label>
        ...
        <div class="col-md-4">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Cuenta </label>
       ...
       <div class="col-md-4">
         ...
         <div class="col-md-4">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Código Producto </label>
...
<!--  ---------------------------------- -->
        ...
        <form method="post" action="{{ route('purchase.store') }}">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-info" id="storeButton"> Guardar Ingreso</button>
