...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('purchase.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle">  Purchase Pending </i></a> <br>  <br>               
                    ...
                    <h4 class="card-title">Ingresos pendientes de confirmar </h4>
            ...
            <tr>
                ...
                <td> 
@if($item->status == '0')
<a href="{{ route('purchase.approve',$item->id) }} " class="btn btn-danger sm" title="Confirmar" id="ApproveBtn">  <i class="fas fa-check-circle"></i> </a>
@endif
                </td>
