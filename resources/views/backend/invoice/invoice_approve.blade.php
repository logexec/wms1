 ...
 <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Confirmar Egreso</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
<h4>Egreso No: #{{ $invoice->invoice_no }} - {{ date('d-m-Y',strtotime($invoice->date)) }} </h4>
         ...
         <table border="1" class="table table-dark" width="100%">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="background-color: #8B008B">Stock Actual</th>
    ...
    <tbody>
        ...
        <tr>
         ...
         <button type="submit" class="btn btn-info">Confirmar Egreso </button>
