...
<div class="col-12">
    <div class="card">
        <div class="card-body"> 
            ...
            <h4 class="card-title">Agregar Egreso  </h4><br><br>
    ...
    <div class="row">
         ...
         <div class="col-md-1">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Pick No</label>
       ...
       <div class="col-md-3">
            <div class="md-3">
                <label for="example-text-input" class="form-label">Familia </label>
...
<div class="col-md-2">
    <div class="md-3">
        ...
        <i class="btn btn-secondary btn-rounded waves-effect waves-light fas fa-plus-circle addeventmore"> Agregar Producto</i>
    </div>
</div>
        ...
        <!--<tr>
            ...
            <div class="form-row">
                <div class="form-group col-md-12">
                    <textarea name="description" class="form-control" id="description" placeholder="Escriba la descripción aquí"></textarea>
                </div>
            </div><br>
...
<div class="row new_customer" style="display:none">
    <div class="form-group col-md-4">
        <input type="text" name="name" id="name" class="form-control" placeholder="Escriba el nombre de la cuenta">
    </div>

    <div class="form-group col-md-4">
        <input type="text" name="mobile_no" id="mobile_no" class="form-control" placeholder="Escriba el No de teléfono">
    </div>

    <div class="form-group col-md-4">
        <input type="email" name="email" id="email" class="form-control" placeholder="Escriba el correo electrónico">
    </div>
</div>
<!-- End Hide Add Customer Form -->
 ...
 <br>
            <div class="form-group">
                <button type="submit" class="btn btn-info" id="storeButton"> Guardar Egreso</button>
...
<tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <input type="hidden" class="form-control unit_price text-right" name="unit_price[]" value="0"> 
    <input type="hidden" class="form-control selling_price text-right" name="selling_price[]" value="0" readonly> 
   <!-- <td>
