...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('supplier.add') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Nueva Cuenta </i></a> <br>  <br>               

                    <h4 class="card-title">Listado de Cuentas Existentes </h4>
