...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Crear Punto de Entrega</h4><br><br>
        
            <form method="post" action="{{ route('destinatario.store') }}" id="myForm">
                @csrf
        ...
        <!-- end row -->                
            ...
            <input type="submit" class="btn btn-info waves-effect waves-light" value="Agregar Punto de Entrega">
        </form>
