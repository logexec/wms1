...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Modificar Transportista</h4><br><br>
        
            <form method="post" action="{{ route('transportista.update') }}" id="myForm">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select name="account_id" class="form-group form-select" aria-label="Default select example">
                            ...
                            <option value="{{ $cta->id }}"  @if ($transportista->account_id == $cta->id) {{ 'selected' }} @endif>{{ $cta->name }}</option>
                           @endforeach
                            </select>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="name" class="form-control" type="number" maxlength="10" minlength="10" value="{{ $transportista->name }}">
                </div>
            </div>
            <!-- end row -->            
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="company_name" class="form-control" type="text" value="{{ $transportista->company_name }}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="identification" class="form-control" type="text"  value="{{ $transportista->identification }}">
                </div>
            </div>
            <!-- end row -->   
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <select class="form-control" name="city">
                        <option value="">..</option>
                        <option value="QUITO"  @if ($transportista->city == "QUITO") {{ 'selected' }} @endif>QUITO</option>
                        <option value="GUAYAQUIL" @if ($transportista->city == "GUAYAQUIL") {{ 'selected' }} @endif>GUAYAQUIL</option>                                           
                    </select>
                </div>
            </div>
            <!-- end row -->      
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <select class="form-control" name="state">
                        <option value="">..</option>
                        <option value="PICHINCHA"  @if ($transportista->state == "PICHINCHA") {{ 'selected' }} @endif>PICHINCHA</option>
                        <option value="GUAYAS"  @if ($transportista->state == "GUAYAS") {{ 'selected' }} @endif>GUAYAS</option>                                           
                    </select>
                </div>
            </div>
            <!-- end row -->                
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <select class="form-control" name="country">                        
                        <option value="ECUADOR"  @if ($transportista->country == "ECUADOR") {{ 'selected' }} @endif>ECUADOR</option>                                                                
                    </select>
                </div>
            </div>
            <!-- end row -->  
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="zip" class="form-control" type="text"  value="{{ $transportista->zip }}">
                </div>
            </div>
            <!-- end row -->
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="address" class="form-control" type="text" maxlength="255"  value="{{ $transportista->address }}">
                </div>
            </div>
            <!-- end row -->                 
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="phone" class="form-control" type="number" value="{{ $transportista->phone }}">
                </div>
            </div>
            <!-- end row -->             
            ...
            <div class="row mb-3">
                ...
                <div class="form-group col-sm-10">
                    <input name="email" class="form-control" type="email" value="{{ $transportista->email }}">
                </div>
            </div>
            <!-- end row -->                  
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    ...
                    <select class="form-control" name="status">
                        @if ($transportista->status == 'ACTIVO')
                            <option selected value="ACTIVO">ACTIVO</option>
                        @else
                            <option value="ACTIVO">ACTIVO</option>
                        @endif
                        
                        @if ($transportista->status == 'INACTIVO')
            ...
            <input type="submit" class="btn btn-info waves-effect waves-light" value="Actualizar Transportista">
        </form>
