...
<div class="col-12">
    <div class="card">
        <div class="card-body">
            ...
            <h4 class="card-title">Agregar Nueva Bodega </h4><br><br>
    ...
    <form method="post" action="{{ route('customer.store') }}" id="myForm" enctype="multipart/form-data" >
            ...
            <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label"> Código de la Bodega </label>
  ...
  <div class="row mb-3">
            ...
            <!-- end row -->
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Imagen Bodega </label>
                <div class="form-group col-sm-10">
