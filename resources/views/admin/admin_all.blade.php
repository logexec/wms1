...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{ route('admin.useradd') }}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> <font style="font-family:'Gill Sans', 'Gill Sans MT', Calibri, 'Trebuchet MS', sans-serif">Nuevo Usuario</font> </i></a> <br>  <br>               
